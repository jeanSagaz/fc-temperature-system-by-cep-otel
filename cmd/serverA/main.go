...
import (
	...
	"github.com/jeanSagaz/temperature-system-by-cep-otel/internal/application/infra/web"
	"github.com/jeanSagaz/temperature-system-by-cep-otel/pkg/telemetry"
...
func main() {
	...
	// local
	//shutdown, err := telemetry.InitProvider("serviceA", "localhost:4317")
	// docker
