...
import (
	...
	"github.com/jeanSagaz/temperature-system-by-cep-otel/internal/application/dto"
	"github.com/jeanSagaz/temperature-system-by-cep-otel/internal/application/services"
...
func getWeatherServiceB(ctx context.Context, city string) (*dto.WeatherResponse, error) {
	...
	// local
	//req, err := http.NewRequestWithContext(ctx, "POST", "http://localhost:8081/v1/weather", jsonVar)
	// docker
